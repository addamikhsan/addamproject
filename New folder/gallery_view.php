		...
		<header>
			<div class="container">
				<div class="fh5co-navbar-brand">
					<a class="fh5co-logo" href="index.html">Cekrek</a>    
				</div>
				...
				<div id="portfoliolist" class="animate-box">
					...
					<div class="portfolio all logo" data-cat="logo">
						<div class="portfolio-wrapper">
							<img src="<?php echo base_url ('assets/gallery/images/portfolio_pic1.jpg') ?>" alt="" />
								<div class="label-text">
									<a href="Andrew.html" class="text-title">Camera</a>
					...
					<div class="portfolio all card web" data-cat="card">
						<div class="portfolio-wrapper">			
							<img src="<?php echo base_url ('assets/gallery/images/portfolio_pic2.jpg') ?>" alt="" />
							<div class="label">
								<div class="label-text">
									<a href="Andrew.html" class="text-title">Camera</a>
					...
					<div class="portfolio all web" data-cat="web">
						<div class="portfolio-wrapper">						
							<img src="<?php echo base_url ('assets/gallery/images/portfolio_pic3.jpg') ?>" alt="" />
							<div class="label">
								<div class="label-text">
									<a href="Andrew.html" class="text-title">Camera</a>
					...
					<div class="portfolio all card" data-cat="card">
						<div class="portfolio-wrapper">			
							<img src="<?php echo base_url ('assets/gallery/images/portfolio_pic4.jpg') ?>" alt="" />
							<div class="label">
								<div class="label-text">
									<a href="member/Brandon.html" class="text-title">Camera</a>
					...
					<div class="portfolio all app" data-cat="app">
						<div class="portfolio-wrapper">
							<img src="<?php echo base_url ('assets/gallery/images/portfolio_pic5.jpg') ?>" alt="" />
							<div class="label">
								<div class="label-text">
									<a href="member/Brandon.html" class="text-title">Camera</a>
					...
					<div class="portfolio all card" data-cat="card">
						<div class="portfolio-wrapper">			
							<img src="<?php echo base_url ('assets/gallery/images/portfolio_pic6.jpg') ?>" alt="" />
							<div class="label">
								<div class="label-text">
									<a href="member/Brandon.html" class="text-title">Camera</a>
									<span class="text-category">Business card</span>
					...
					<div class="portfolio all card" data-cat="card">
						<div class="portfolio-wrapper">			
							<img src="<?php echo base_url ('assets/gallery/images/portfolio_pic7.jpg') ?>" alt="" />
							<div class="label">
								<div class="label-text">
									<a href="member/Risky.html" class="text-title">Camera</a>
									<span class="text-category">Business card</span>
								</div>
								<div class="label-bg"></div>
							</div>
					...
					<div class="portfolio all logo" data-cat="logo">
						<div class="portfolio-wrapper">			
							<img src="<?php echo base_url ('assets/gallery/images/portfolio_pic8.jpg') ?>" alt="" />
							<div class="label">
								<div class="label-text">
									<a href="member/Risky.html" class="text-title">Camera</a>
									<span class="text-category">Logo</span>
					...
					<div class="portfolio all icon" data-cat="icon">
						<div class="portfolio-wrapper">			
							<img src="<?php echo base_url ('assets/gallery/images/portfolio_pic9.jpg') ?>" alt="" />
							<div class="label">
								<div class="label-text">
									<a href="member/Risky.html" class="text-title">Camera</a>
