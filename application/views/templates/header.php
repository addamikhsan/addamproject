...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
		...
		<div class="js-fullheight fh5co-table">
			<div class="fh5co-table-cell js-fullheight">
				<ul>
					...
					<li><a href="<?php echo base_url('gallery/logout'); ?>">Logout</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<center>
	<a href="<?=base_url()?>gallery/tambah" class="btn btn-success">Upload</a>

	<div class="container">
		<br>
      <form action="<?=base_url()?>gallery/index" method="get">
